...
Для первого блока задач делай внешнюю обработку: одна задача — одна кнопка. Код каждой задачи размещай в обработчике соответствующей кнопки. Интерфейс здесь нужен только как простая оболочка для запуска кода.
